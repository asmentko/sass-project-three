class ConfirmationsController < Milia::ConfirmationsController
  ...
  # als copy pasted right from milia confirmations_controler file
  def update
  ...
  # als copy pasted from milia confirmations_controller file and then edited log action(devise pass-thru)
  def show
